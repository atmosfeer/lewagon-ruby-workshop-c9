def sum_odd_indexed(array)
  ...
  #       Once again, to be extra clear. Do NOT compute the sum of elements,
  #       but the sum of elements with an odd INDEX in the array
...
require 'rspec'
RSpec::Core::Runner.run(['../spec/enumerable_spec.rb'])
############################################################
